...
const Container = ({}) => {
  ...
  let [stockBuySellDetails, setstockBuySellDetails] = useState({ date: new Date().toJSON().toString().substring(0, 10), nameOfStock: "", Qty: 0, Buying: 0, Selling: 0 });
  ...
  return (
    <div className='w-full bg-zinc-800 py-2 px-2 lg:p-4 h-auto'>
      <div className='flex items-center justify-center flex-col w-full h-auto'>
        ...
        <StockModal stockBuySellDetails={stockBuySellDetails} showDetails={showDetails} setshowDetails={setshowDetails} addStock={addStock} handleChange={handleChange} />
